    ...
    switch (parser.state) {
      case S.NEW_PART:
        ...
        if (parser.buffer.substr(len, 2) === "--") {
          ...
          this.emit("onPartEnd", parser.part);
      ...
      case S.HEADER:
        ...
        // let the world know
        this.emit("onPartBegin", parser.part);
      ...
      case S.BODY:
        ...
        if (offset === -1) {
          ...
          if (emittable > 0) {
            this.emit("onData", parser.buffer.substr(0, emittable));
        ...
        if (offset > 0) {
          ...
          if (emittable) this.emit("onData", emittable);
